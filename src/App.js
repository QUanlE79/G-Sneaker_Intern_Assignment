...
// Update cart data and total amount in local storage when changed
useEffect(() => {
                    ...
                    <div className="shoe-bottom">
                      ...
                      <div >
                        {cardData.some(item => item.id === shoe.id) ? (
                          <p className="shoe-added">
                            <img src="/assets/check.png" alt="Done" />
                          </p>
                        ) : (
                          <p className="shoe-add-btn" onClick={() => handleAddToCart(shoe)}>
                            ADD TO CART
                          </p>
                        )}
                      </div>
        ...
        <div className="cart-section">
          <div className="card">
            ...
            <div className="product-header">Your cart
              <span className="total-price" style={{ float: "right" }}>
                    ...
                    <div className="shoe-cart-item" key={shoe.id}>
                      ...
                      <div className="shoe-cart-right">
                        ...
                        <div class="action">
                          ...
                          <div class="remove" onClick={() => removeProduct(shoe)}>
